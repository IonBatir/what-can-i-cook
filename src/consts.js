export const APP_NAME = "What Can I Cook?";
...
export const FOOD_SCREEN = "FOOD_SCREEN";
export const FOOD_INFO_SCREEN = "FOOD_INFO_SCREEN";
export const RECIPE_SCREEN = "RECIPE_SCREEN";
export const RECIPE_INFO_SCREEN = "RECIPE_INFO_SCREEN";
